...
const RESPONSE_MSG = {
  DEFAULT: '',
  PENDING: '',
  SUCCESS: 'Message sent! A copy will be sent to your provided email address.',
...
const Contact = () => {
  ...
  return (
    ...
    >
      ...
      >
        {responseFromContactBox.isLoading || responseFromContactBox.data
          ? SEND_BUTTON_MSG.SUCCESS
          : responseFromContactBox.error
          ? SEND_BUTTON_MSG.ERROR
          : SEND_BUTTON_MSG.DEFAULT}
      </button>
      ...
      >
        {responseFromContactBox.data
          ...
          : responseFromContactBox.error
          ? responseFromContactBox.error.message
            ? `Something went wrong. ${responseFromContactBox.error.message}`
            : RESPONSE_MSG.ERROR
