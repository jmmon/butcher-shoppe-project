  ...
  return (
    ...
    >
      <div className={`grid-row-gap-8 padding-2--bot ${Styles.container}`}>
        ...
        >
          <p>
            Our meat processing Shoppe in <a href='#map'>Northport</a> is
            currently under construction. Once complete, we will be able to
            process your animal carcasses in-house, helping bring your favorite
            cuts from your pasture to your table!
          </p>
          <p>
            We slaughter all sorts of larger animals, including beef, hogs,
            goats, lambs, bison, and exotic animals like alpacas, lamas and emu.
          </p>
        ...
        <ComponentInView marginPx={CONSTANTS.OFFSET.THIRD}>
          ...
          >
            <p>
              Stay up to date on the progress of our Shoppe by subscribing to
              our <a href='/newsletter/subscribe'>newsletter.</a> When our
              Butcher Shoppe in downtown Northport is operational, our{' '}
              <a href='/newsletter/subscribe'>newsletter</a> subscribers will be
              the first to know!
            </p>
