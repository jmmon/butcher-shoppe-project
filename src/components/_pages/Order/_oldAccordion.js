			...
			<section className="order-form--section">
				...
				<div className="order-form--field">
					...
					<div className="order-form--checkbox-container">
						...
						/>
						<label htmlFor="extras_liver__checkbox">LIVER</label>
						...
						/>
						<label htmlFor="extras_heart__checkbox">HEART</label>
						...
						/>
						<label htmlFor="extras_tongue__checkbox">TONGUE</label>
						...
						/>
						<label htmlFor="extras_oxtail__checkbox">OXTAIL</label>
					</div>
				</div>
			</section>
		</AccordionItem>
