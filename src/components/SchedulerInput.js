...
const DateTimePicker = ({selectHandler}) => {
  ...
  const MyContainer = ({ className, children }) => {
    return (
      <div style={{ padding: "12px", background: "#216ba5", color: "#fff", borderRadius: "5px" }}>
		...
		<div className="form-container panel--shadow card">
			<form>
				<div className="date input-container">
					...
					<DatePicker
						className="date-time-picker schedule--input"
						selected={startDate}
				...
				<div className="name input-container">
					<label htmlFor="name" className="name schedule--label">Your Name</label>
					<input 
						id="name" 
						type="text" 
						className="name schedule--input" 
						name="name"
				...
				<div className="phone input-container">
					<label htmlFor="phone" className="phone schedule--label">Your Phone Number</label>
					<PhoneInput 
				...
				<button className="btn btn--primary--dark" onClick={handleSubmit} >Submit Info</button>
