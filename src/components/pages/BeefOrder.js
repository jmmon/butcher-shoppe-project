...
function BeefOrder() {
	...
	// useEffect(() => {
	// 	console.log(activeClickedItems);
	// }, [activeClickedItems]);
	...
	useEffect(() => {
		console.log("activeClickedItems", activeClickedItems);
	});
	...
	const closeAll = (e) => {
		// console.log("closeAll pressed, e:", e);
		e.preventDefault();
		setActiveClickedItems([]);
	};

	// const handleClick = ({ activeItems }) => {
	// 	setActiveClickedItems(activeItems);
	// 	console.log("handle click fired");
	// };

	const onExpand = (index) => {
		console.log("onExpand index: ", index);
				...
				<form className="order-form card panel--shadow">
					<div className="accordion-wrapper card">
						...
						<Accordion
							...
							// 		"changes"
							// 	).innerHTML = `${newState.activeItems}`)
							// }
						>
							<AccordionItem
								titleClassName="card"
								...
								<section className="order-form--section">
									...
									<div className="order-form--field">
										<label
											...
											className="order-form--label"
										>
											Tenderized Round Steaks (steaks are
											run through the cuber - similar to
											pounding them) *Additional Fee - See
											Price List
										</label>
									...
									<div className="order-form--field">
										...
										>
											...
											hamburger, made into roasts or or
											made into Jerky *Additional fee -
											See Price List
										</label>
									...
									<div className="order-form--field">
										<label
											...
											className="order-form--label"
										>
											Tenderloin (The eye of the loin
											taken out separately from the T-Bone
											and Sirloin steaks and cut 1 1/2"
								...
								<section className="order-form--section">
									...
									<div className="order-form--field">
										<label
											...
											className="order-form--label"
										>
											Roast Size (we suggest a 3-4# roast
											for a family of 2-4)
										</label>
									...
									<div className="order-form--field">
										...
										>
											...
											in) *Additional fee - See Price List
										</label>
									...
									<div className="order-form--field">
										<label
											...
											className="order-form--label"
										>
											Remove Bone Dust *Additional fee -
											See Price List
										</label>
								...
								<section className="order-form--section">
									...
									<div className="order-form--field">
										<label
											...
											className="order-form--label"
										>
											Ground Beef Patties (1/4# patties,
											30# minimum) *Additional fee - See
											Price List
										</label>
